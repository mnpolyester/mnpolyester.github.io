# M.N. Polyester logo assets

These files are faithful, deterministic vector traces of the existing M.N. Polyester logo published on `mnpolyester.in`. The shapes and proportions have not been generatively redesigned.
...
Prefer SVG for the website. Preserve the aspect ratio, keep clear space around the mark, and do not recolor, rotate, stretch, or rearrange its elements.
